...
export class ResultView {
    ...
    private _getHtmlForWebview(results: any[]) {
        const cssUri = this._panel.webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, 'media', 'resultView.css'));
        const scriptUri = this._panel.webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, 'media', 'resultTable.js'));
