...
import { TableComparisonResult, ProcedureComparisonResult, DiffStatus } from './schemaComparer';
...
export class SchemaCompareView {
    ...
    public static createOrShow(extensionUri: vscode.Uri, result: TableComparisonResult | ProcedureComparisonResult, comparisonType: 'table' | 'procedure') {
